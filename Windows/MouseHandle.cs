...
namespace PublicUtility.MouseRun.Windows {
  ...
  internal static class MouseHandle {
    ...
    internal static void RollDown(uint clicks) {
      if(clicks < 0)
    ...
    internal static void RollUp(uint clicks) {
      if(clicks < 0)
        throw new Exception($"{nameof(clicks)} cannot be less than zero.");
    ...
    internal static PointIntoScreen GetPosition() {
      try {
    ...
    internal static void Drag(PointIntoScreen start, PointIntoScreen end, MouseSpeed speed = MouseSpeed.X1) {
      MoveTo(start, speed);
      Thread.Sleep(300);
    ...
    internal static void LeftClick(bool doubleClick = false) {
      if(doubleClick) {
    ...
    internal static void RightClick(bool doubleClick = false) {
      if(doubleClick) {
    ...
    internal static void MoveToAndClick(PointIntoScreen point, MouseSpeed speed = MouseSpeed.X2, bool doubleClick = false, bool leftbtn = true) {
      MoveTo(point, speed);
      if(leftbtn)
    ...
    internal static void MoveTo(PointIntoScreen point, MouseSpeed speed = MouseSpeed.X1) {
